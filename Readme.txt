...
Challenge A
For Challenge A, I used TypeScript and decided to run the script using Deno (https://deno.com/runtime). Deno allows direct execution of TypeScript files without additional configuration.
